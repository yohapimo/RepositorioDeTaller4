...
public class Uranium extends Planets {
     ...
     * @param constG
     */
    public Uranium(int id, String name, double mass, double density, double diameter, double sun_distance, double constG) {
    ...
    public void CreateUranium() {
         ...
         * con respecto al sol.
         */
        System.out.println("La atracción gravitatoria de la Tierra es: " + respuesta + " NW");
