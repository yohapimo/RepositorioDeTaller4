...
public class Venus extends Planets {
     ...
     * @param constG
     */
    public Venus(int id, String name, double mass, double density, double diameter, double sun_distance, double constG) {
    ...
    public void CreateVenus() {
         ...
         * con respecto al sol.
         */
        System.out.println("La atracción gravitatoria de Venus es: " + respuesta + " Nw");
